...
<div class="min-h-screen bg-[#0B1120] text-gray-100 px-6 py-12">
    ...
    <div class="flex items-center justify-between mb-10">
        <h1 class="text-3xl font-bold text-[#00C2FF]">Available Courses</h1>
    ...
    @else
        ...
        <div class="text-center mt-24">
            <div class="bg-[#101B2E] border border-[#1E2B4A] rounded-2xl p-10 inline-block shadow-md max-w-md">
                ...
                <p class="text-gray-400 mb-6">There are no available courses right now. Check back later for new opportunities!</p>
