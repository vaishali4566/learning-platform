...
<div class="bg-[#101727] min-h-screen p-6 rounded-lg">
    ...
    <p class="text-[#8A93A8] mb-8">Manage your courses, students, and analytics efficiently from one place.</p>

    <!-- Dashboard Cards -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div class="bg-gradient-to-br from-[#1C2541] to-[#11182A] border-l-4 border-[#00C2FF] p-4 rounded-lg shadow-md hover:shadow-[#00C2FF]/30 transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="bg-gradient-to-br from-[#1C2541] to-[#11182A] border-l-4 border-[#16a34a] p-4 rounded-lg shadow-md hover:shadow-[#16a34a]/30 transition-all duration-300 transform hover:-translate-y-1">
            <h2 class="text-[#E6EDF7] font-semibold flex items-center gap-2">
        ...
        <div class="bg-gradient-to-br from-[#1C2541] to-[#11182A] border-l-4 border-[#facc15] p-4 rounded-lg shadow-md hover:shadow-[#facc15]/30 transition-all duration-300 transform hover:-translate-y-1">
            <h2 class="text-[#E6EDF7] font-semibold flex items-center gap-2">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Gradients for background fills
