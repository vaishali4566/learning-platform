...
<head>
    ...
    <title>Trainer Reset Password</title>
...
<body class="bg-gradient-to-br from-blue-900 to-green-700 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Trainer Reset Password</h2>
        ...
        {{-- Reset Password Form --}}
        <form method="POST" action="{{ route('trainer.password.update') }}" class="space-y-4">
            @csrf
