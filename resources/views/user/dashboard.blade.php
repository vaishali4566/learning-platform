    ...
    <div class="relative w-full max-w-4xl bg-[#2f76a615] backdrop-blur-md rounded-xl shadow-2xl z-10 border border-white/20 p-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-white/80 mt-2">
                This is your dashboard. View your profile, courses, and manage your account.
            </p>
        </div>

        <!-- Dashboard Cards -->
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            <a href="{{ route('user.profile') }}" class="flex flex-col items-center justify-center bg-[#93a8be46] text-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:scale-105">
