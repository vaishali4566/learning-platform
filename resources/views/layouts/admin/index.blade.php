...
<head>
    ...
    <style>
        ...
        #sidebar {
            background: linear-gradient(to bottom, #0E1625, #1C2541, #0E1625);
            color: white;
        }
    </style>
</head>

<body class="bg-[#0A0E19] flex flex-col h-screen overflow-hidden">

    {{-- NAVBAR --}}
    <div class="fixed top-0 left-0 right-0 z-50 bg-[#0A0E19] border-b border-[#1F2937]">
